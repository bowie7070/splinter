...
void splinter_datatable_add_samples_row_major(
...
void splinter_datatable_add_samples_col_major(
    splinter_obj_ptr datatable_ptr, double* x, int n_samples, int x_dim) {
    auto dataTable = get_datatable(datatable_ptr);
    if (dataTable != nullptr) {
        try {
...
void splinter_datatable_save(
    splinter_obj_ptr datatable_ptr, const char* filename) {
    auto dataTable = get_datatable(datatable_ptr);
    if (dataTable != nullptr) {
        try {
