...
DataTable* get_datatable(splinter_obj_ptr datatable_ptr) {
    ...
    set_error_string(
        "Invalid reference to DataTable: Maybe it has been deleted?");
...
BSpline* get_bspline(splinter_obj_ptr bspline_ptr) {
    ...
    set_error_string(
        "Invalid reference to BSpline: Maybe it has been deleted?");
...
BSpline::Builder* get_builder(splinter_obj_ptr bspline_builder_ptr) {
    ...
    set_error_string(
        "Invalid reference to BSpline::Builder: Maybe it has been deleted?");
