...
void splinter_bspline_builder_set_degree(
...
void splinter_bspline_builder_set_num_basis_functions(
...
void splinter_bspline_builder_set_knot_spacing(
...
void splinter_bspline_builder_set_smoothing(
...
void splinter_bspline_builder_set_alpha(
